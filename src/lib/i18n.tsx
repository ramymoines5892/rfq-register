...
const dict = {
  ...
  setupTitle: { ar: "إعداد حساب المالك", en: "Owner setup" },
  setupHint: { ar: "أول حساب في النظام هو حساب المالك بكامل الصلاحيات.", en: "The first account is the Owner with full privileges." },
  ...
  createOwner: { ar: "إنشاء حساب المالك", en: "Create owner account" },
  ...
  pendingTitle: { ar: "حسابك بانتظار الموافقة", en: "Your account is pending approval" },
  pendingBody: { ar: "تم استلام طلبك. مدير النظام لازم يوافق ويحدد صلاحياتك قبل الدخول.", en: "Your request was received. An admin must approve your account and set permissions." },
  refresh: { ar: "تحديث", en: "Refresh" },
  hr: { ar: "الموارد البشرية", en: "HR" },
  departments: { ar: "الإدارات", en: "Departments" },
  jobTitles: { ar: "المسميات الوظيفية", en: "Job titles" },
  pendingUsers: { ar: "طلبات جديدة", en: "Pending users" },
  activeUsers: { ar: "المستخدمون النشطون", en: "Active users" },
  addDepartment: { ar: "إضافة إدارة", en: "Add department" },
  departmentName: { ar: "اسم الإدارة", en: "Department name" },
  departmentManager: { ar: "مدير الإدارة", en: "Department manager" },
  addJobTitle: { ar: "إضافة مسمى", en: "Add job title" },
  jobTitleName: { ar: "اسم المسمى", en: "Job title" },
  department: { ar: "الإدارة", en: "Department" },
  directManager: { ar: "المدير المباشر", en: "Direct manager" },
  permissions: { ar: "الصلاحيات", en: "Permissions" },
  approveUser: { ar: "الموافقة وتفعيل الحساب", en: "Approve & activate" },
  suspendUser: { ar: "تعليق الحساب", en: "Suspend" },
